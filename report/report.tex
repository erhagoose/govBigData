...
F-statistic:   593 on 9 and 46235 DF,  p-value: < 2.2e-16
    ...
    \begin{figure}[htbp]
      ...
      \label{fig:gfmt-box}
    \end{figure}
    \cref{fig:gfmt-box}中的主题词可以在\url{https://nogeek-static.netlify.com/gov/官方媒体/#lambda=0.2}查询到。其中，“老师”代表的主题（老师，妈妈，孩子，父母，爱，人生）、“民警”代表的主题（民警，男子，老人，司机，女子，派出所，交警）、“香港”代表的主题（香港，共青团中央，青春，全网，祖国，暴力）更受关注，而“招聘”代表的主题（招聘，报名，考生，考试，资格，岗位）则鲜有问津。
    \begin{table}[!htbp] \centering 
